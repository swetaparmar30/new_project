        ...
        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card mb-4">
                <div class="card-header article_heading">
                    ...
                    <a href="<?php echo e(route('team.add')); ?>"><button type="button" class="btn btn-outline-primary">Add
                        Member</button></a>
                </div>
                <div class="card-body">
                    <div class="example">
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/nateb61.sg-host.com/public_html/resources/views/team/index.blade.php ENDPATH**/ ?>