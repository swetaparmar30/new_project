                        ...
                        <div class="row">
                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center products-headings-section">
                                ...
                                <?php if(isset($res['subcategory'][0]['description']) && $res['subcategory'][0]['description'] != ''): ?>
                                    <p><?php echo e($res['subcategory'][0]['description']); ?></p>
                                <?php endif; ?>
                                    ...
                                    <?php $__currentLoopData = $ddpcount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dkey => $dval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 products-box-section">
                                            <article>
                                                ...
                                                <a href="<?php echo e(route('residential.product_detail', [$res['category'], $dval['product_slug']])); ?>/">
                                                    <img src="<?php echo e($dval['list_image']); ?>" width="auto" height="auto" class="img-fluid" alt="">
                                                </a>
                                                <?php endif; ?>

                                                <?php if(isset($dval['list_title'])): ?>
                                                    <h3><a href="<?php echo e(route('residential.product_detail', [$res['category'], $dval['product_slug']])); ?>/"><?php echo e($dval['list_title']); ?></a></h3>
                                                <?php endif; ?>
                                                ...
                                                <div class="learn-more-btn-sec">
                                                    <a href="<?php echo e(route('residential.product_detail', [$res['category'], $dval['product_slug']])); ?>/" class="common-btn">Learn More</a>
                                                </div>
                                            </article>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <?php if(isset($dlst['list_title'])): ?>
                                                        <h3><a href="<?php echo e(route('residential.product_detail', [$res['category'], $dlst['product_slug']])); ?>/"><?php echo e($dlst['list_title']); ?></a></h3>
                                                    <?php endif; ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <div class="learn-more-btn-sec">
                                                        <a href="<?php echo e(route('residential.product_detail', [$res['category'], $dlst['product_slug']])); ?>/" class="common-btn">Learn More</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <?php if(isset($dlst['list_image']) && $dlst['list_image'] != null && $dlst['list_image'] != ''): ?>
                                                <a href="<?php echo e(route('residential.product_detail', [$res['category'], $dlst['product_slug']])); ?>/" class="image-link">
...
<?php echo $__env->make('frontend.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/frontend/product/residentialsubcategory.blade.php ENDPATH**/ ?>