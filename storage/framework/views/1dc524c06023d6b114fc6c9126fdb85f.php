                            ...
                            <div class="row">
                                <div
                                    ...
                                    <div class="card Recent-Users">
                                     ...
                                     <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                        <textarea class="form-control rich-text-editor" id="" name="footer_text" style="height: 100px;"><?php echo e(isset($setting->footer_text) ? $setting->footer_text : ''); ?></textarea>
                                     </div>
                                     </div> -->
                                            <!-- <div class="row form-sec">
                                     <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                     ...
                                     <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                        <textarea class="form-control rich-text-editor" id="map" name="map" style="height: 200px;"><?php echo e(isset($setting->map) ? $setting->map : ''); ?></textarea>
                                     </div>
                                     </div> -->
                                            <?php if(!in_array(auth()->user()->role, ['dealer', 'marketing'])): ?>
                                                <div class="row form-sec">
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" id="meta_description" name="meta_description" style="height: 150px;"
...
<?php else: ?>
    ...
    <?php endif; ?>
                               ...
                               <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 label-sec">
                                   ...
                                   <textarea class="form-control rich-text-editor" id="cta_description" required=""
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Clark_Dynamic_site_DEC\resources\views/settings/index.blade.php ENDPATH**/ ?>