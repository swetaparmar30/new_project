                                                    ...
                                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <?php if(isset($dlst['slug'])): ?>
                                                            <?php if(isset($dlst['image']) && $dlst['image'] != null && $dlst['image'] != ''): ?>
                                                                ...
                                                                <?php elseif($dlst['link_sub_category'] != null || $dlst['link_sub_category'] != ''): ?>
                                                                    <a href="<?php echo e(route('commercial.products', [$dval['link_sub_category']])); ?>/" class="image-link">
                                                                        <img src="<?php echo e($dlst['image']); ?>" width="auto" height="auto" class="img-fluid" alt="">
                                                                    </a>
                                                                <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk13.sg-host.com/public_html/resources/views/frontend/product/commercialcategory.blade.php ENDPATH**/ ?>