...
<?php
    $systemImageAlt = 'S&K Door';

    if (request()->is('/')) {
        $systemImageAlt = 'delaware garage door installation';
    } 
    elseif (request()->is('locations/newport-garage-doors')) {
        $systemImageAlt = 'newport garage door installation';
    } 
    elseif (request()->is('locations/dover-garage-doors')) {
        $systemImageAlt = 'dover garage door installation';
    }
     elseif (request()->is('locations/georgetown-garage-doors')) {
        $systemImageAlt = 'georgetown garage door installation';
    } 
    elseif (request()->is('locations/salisbury-garage-doors')) {
        $systemImageAlt = 'salisbury garage door installation';
    }
     elseif (request()->is('service-areas/berlin-md-garage-doors')) {
        $systemImageAlt = 'berlin garage door installation';
    } 
     elseif (request()->is('service-areas/bethany-beach-de-garage-doors')) {
        $systemImageAlt = 'bethany beach garage door installation';
    } 
     elseif (request()->is('service-areas/dewey-beach-de-garage-doors')) {
        $systemImageAlt = 'dewey beach garage door installation';
    } 
     elseif (request()->is('service-areas/fenwick-island-de-garage-doors')) {
        $systemImageAlt = 'fenwick island garage door installation';
    } 
     elseif (request()->is('service-areas/lewes-de-garage-doors')) {
        $systemImageAlt = 'lewes garage door installation';
    } 
     elseif (request()->is('service-areas/ocean-city-md-garage-doors')) {
        $systemImageAlt = 'ocean city garage door installation';
    } 
     elseif (request()->is('service-areas/ocean-pines-md-garage-doors')) {
        $systemImageAlt = 'ocean pines garage door installation';
    } 
     elseif (request()->is('service-areas/rehoboth-beach-de-garage-doors')) {
        $systemImageAlt = 'rehoboth beach garage door installation';

    } elseif (request()->is('service-areas/smyrna-de-garage-doors')) {
        $systemImageAlt = 'smyrna garage door installation';
    }
     elseif (request()->is('service-areas/townsend-de-garage-doors')) {
        $systemImageAlt = 'townsend garage door installation';
    }
    elseif (request()->is('service-areas/odessa-de-garage-doors')) {
        $systemImageAlt = 'odessa garage door installation';
    }
    elseif (request()->is('service-areas/middletown-de-garage-doors')) {
        $systemImageAlt = 'middletown garage door installation';
    }
    elseif (request()->is('service-areas/camden-wyoming-de-garage-doors')) {
        $systemImageAlt = 'camden wyoming garage door installation';
    }
    elseif (request()->is('service-areas/newark-de-garage-doors')) {
        $systemImageAlt = 'newark garage door installation';
    }
    elseif (request()->is('service-areas/frederica-de-garage-doors')) {
        $systemImageAlt = 'frederica garage door installation';
    }
    elseif (request()->is('service-areas/magnolia-de-garage-doors')) {
        $systemImageAlt = 'magnolia garage door installation';
    }
    
    
    
    
    elseif (!empty($system_setting->system_setting_title)) {
        $systemImageAlt = $system_setting->system_setting_title;
    }
?>
