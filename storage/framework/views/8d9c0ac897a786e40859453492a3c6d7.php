                              ...
                              <div class="inner-div">
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" style=" background: transparent; ">
                                  ...
                                  <div class="location-grid">
                                      ...
                                      <div class="location-item">
                                        <p>Georgetown</p>
                                        <a href="<?php echo e(isset($setting->contact_no4) ? 'tel:+1' . preg_replace('/[^0-9]/', '', $setting->contact_no4) : ''); ?>" class="common-btn header-booking-apt-btn"><img src="<?php echo e(asset('uploads/phone-image-new.svg')); ?>"><span><?php echo e(isset($setting->contact_no4) ? $setting->contact_no4 : ''); ?></a>
                                        </div>
                                      <?php endif; ?>
                                      <?php if(isset($setting->contact_no5)): ?>
                                      <div class="location-item">
                                        <p>Salisbury</p>
                                        <a href="<?php echo e(isset($setting->contact_no5) ? 'tel:+1' . preg_replace('/[^0-9]/', '', $setting->contact_no5) : ''); ?>" class="common-btn header-booking-apt-btn"><img src="<?php echo e(asset('uploads/phone-image-new.svg')); ?>"><span><?php echo e(isset($setting->contact_no5) ? $setting->contact_no5 : ''); ?></a>
                                        </div>
                                      <?php endif; ?>
                                  </div>
                                  <!-- <div class="location-wise-contact">
