                                        ...
                                        <div class="row form-sec">
                                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 label-sec">
                                                <div class="upload-img-sec text-center">
                                                    ...
                                                    <img src="<?php echo e(asset('storage/uploads/'.$img->name)); ?>" alt="" id="profile_avtar" class="profile-img" id="profile_avtar"> 
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/nateb61.sg-host.com/public_html/resources/views/testimonials/add.blade.php ENDPATH**/ ?>