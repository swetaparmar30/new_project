                                        ...
                                        <div class="card-block">
                                            <div class="row align-items-center justify-content-center">
                                                ...
                                                <div class="col text-right">
                                                    ...
                                                    <h5 class="text-c-purple mb-0 dashboard_heading"><span
                                                            class="text-muted">Total Pages</span></h5>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <div class="card card-social">
                                        <div class="card-block">
                                            <div class="row align-items-center justify-content-center">
                                                <div class="col-auto">
                                                    <i class="feather icon-globe text-c-red f-36"></i>
                                                </div>
                                                <div class="col text-right">
                                                    <h3><?php echo e(isset($collection) ? $collection : 0); ?></h3>
                                                    <h5 class="text-c-blue mb-0 dashboard_heading"><span
                                                            class="text-muted">Collections</span></h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-block">
                                            <div class="row align-items-center justify-content-center">
                                                ...
                                                <div class="col text-right">
                                                    ...
                                                    <h5 class="text-c-blue mb-0 dashboard_heading"><span
                                                            class="text-muted">Inquirys</span></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk13.sg-host.com/public_html/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>