    ...
    <div class="container-md">
        <div class="row align-items-center">
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 left-side">
                ...
                <?php if(isset($system_setting->system_setting_description_1) && $system_setting->system_setting_description_1 != ''): ?>
                    <div class="mt-3">
                        <?php echo $system_setting->system_setting_description_1; ?>
    ...
    <section class="year-of-excilence sandk-common">
        <div class="container-md">
            <div class="row align-items-center">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 left-side">
                    <?php if(isset($system_setting->system_img9) && $system_setting->system_img9 != null): ?>
                        <?php
                            $img = App\Models\MediaImage::where('id', $system_setting->system_img9)->first();
                        ?>
                        <?php if(isset($img->name) && $img->name != null): ?>
                            <img src="<?php echo e(asset('uploads/' . $img->name)); ?>" class="img-fluid"
                                alt="<?php echo e($img->alt_text ?: $system_setting->system_setting_title_1  ?? 'Garage Door'); ?>"
                                loading="lazy" width="1000" height="592.88">
                        <?php endif; ?>
                    <?php else: ?>
                        <img src="<?php echo e(asset('front-assets/src/images/51-Years-Of-Excellence.webp')); ?>"
                    ...
                    <?php if(isset($system_setting->system_setting_description_2) && $system_setting->system_setting_description_2 != ''): ?>
                        <div class="mt-3">
                            <?php echo $system_setting->system_setting_description_2; ?>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 right-side">
                    ...
                    <?php if(isset($system_setting->system_setting_title_1) && $system_setting->system_setting_title_1 != ''): ?>
                        <h2><?php echo e($system_setting->system_setting_title_1); ?> <span>
                                <?php echo e($system_setting->system_sub_title_1); ?></span></h2>
                    <?php endif; ?>

                <?php if(isset($system_setting->system_img9) && $system_setting->system_img9 != null && $img->name && $img->name != null): ?>
                    <?php if(isset($img->name) && $img->name != null): ?>
                        <img src="<?php echo e(asset('uploads/' . $img->name)); ?>" class="img-fluid mobile-img"
                            alt="<?php echo e($img->alt_text ?: $system_setting->system_setting_title_1 ?? 'Garage Door'); ?>"
                            loading="lazy" width="1000" height="500">
                ...
                <?php if(isset($system_setting->system_setting_description_3) && $system_setting->system_setting_description_3 != ''): ?>
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 center-side-list desktop">
                <ul class="with-icon-list ">
                    <?php if(isset($system_setting->title5) && $system_setting->title5 != ''): ?>
                        <?php if(isset($system_setting->system_img5) && $system_setting->system_img5 != null): ?>
                            <?php
                            ...
                            ?>
                            <?php if(isset($img5->name) && $img5->name != null): ?>
                                <?php
                        ...
                        <?php endif; ?>
                        <li
                            <?php if(isset($url5)): ?> style="background-image: url(<?php echo e($url5); ?>)" <?php endif; ?>>
                            <div>
                                <span class="text-span"><?php echo $system_setting->title5; ?></span>
                            </div>
                        </li>
                    <?php endif; ?>
                    <?php if(isset($system_setting->title6) && $system_setting->title6 != ''): ?>
                        <?php if(isset($system_setting->system_img6) && $system_setting->system_img6 != null): ?>
                            <?php
                            ...
                            ?>
                            <?php if(isset($img6->name) && $img6->name != null): ?>
                                <?php
                        ...
                        <?php endif; ?>
                        <li
                            <?php if(isset($url6)): ?> style="background-image: url(<?php echo e($url6); ?>)" <?php endif; ?>>
                            <div>
                                <span class="text-span"><?php echo $system_setting->title6; ?></span>
                            </div>
                        </li>
                    <?php endif; ?>
                    <?php if(isset($system_setting->title7) && $system_setting->title7 != ''): ?>
                        <?php if(isset($system_setting->system_img7) && $system_setting->system_img7 != null): ?>
                            <?php
                            ...
                            ?>
                            <?php if(isset($img7->name) && $img7->name != null): ?>
                                <?php
                        ...
                        <?php endif; ?>
                        <li
                            <?php if(isset($url7)): ?> style="background-image: url(<?php echo e($url7); ?>)" <?php endif; ?>>
                            <div>
                                <span class="text-span"><?php echo $system_setting->title7; ?></span>
                            </div>
                        </li>
                    <?php endif; ?>
                    <?php if(isset($system_setting->title8) && $system_setting->title8 != ''): ?>
                        <?php if(isset($system_setting->system_img8) && $system_setting->system_img8 != null): ?>
                            <?php
                                $img8 = App\Models\MediaImage::select('name')
                                    ->where('id', $system_setting->system_img8)
                                    ->first();
                            ?>
                            <?php if(isset($img8->name) && $img8->name != null): ?>
                                <?php
                        ...
                        <?php endif; ?>
                        <li
                            <?php if(isset($url8)): ?> style="background-image: url(<?php echo e($url8); ?>)" <?php endif; ?>>
                            <div>
                                <span class="text-span"><?php echo $system_setting->title8; ?></span>
                            </div>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\new_project\resources\views/frontend/includes/systemsetting.blade.php ENDPATH**/ ?>