 <div class="accordion-body">
     ...
     <div class="row">
         ...
         <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
             ...
             <textarea class="form-control" id="service_head_description" name="service_head_description" style="height: 150px;"
         ...
         <div class="col-xxl-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 label-sec">
             ...
             <div class="row form-sec">
                 ...
                 <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <textarea class="form-control" id="service_description" name="service_description[]" style="height: 150px;"
...
<?php /**PATH /home/customer/www/hamzahk13.sg-host.com/public_html/resources/views/settings/service-sec.blade.php ENDPATH**/ ?>