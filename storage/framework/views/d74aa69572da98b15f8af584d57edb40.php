                                ...
                                <div class="card-block px-0 py-3">
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                ...
                                                <textarea class="form-control" id="code_preview0" name="article_content" style="height: 300px;" data-parsley-required="true" data-parsley-required-message="Please enter Content" data-parsley-errors-container="#content_required"><?php echo e(isset($article->content) ? $article->content : ''); ?></textarea>
                            ...
                            <div class="card Recent-Users next-box">
                                ...
                                <div class="card-block px-0 py-3">
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                <textarea name="meta_description" id="" rows="5" cols="10"><?php echo e(isset($article->meta_description) ? $article->meta_description : ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-sec">
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Clark_Dynamic_site_DEC\resources\views/articles/add.blade.php ENDPATH**/ ?>