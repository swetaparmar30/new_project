                    ...
                    <div class="container-md">
                        <div class="row align-items-center">
                            <div class="col-xxl-7 col-xl-7 col-lg-10 col-md-12 col-sm-12 col-12 banner-left-sec justify-content-center align-items-center">
                                ...
                                <a href="<?php echo e(url('/')); ?>" class="common-btn common-btn" id="common-btn">BACK TO HOME</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('frontend.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dealer-New\resources\views/errors/404.blade.php ENDPATH**/ ?>