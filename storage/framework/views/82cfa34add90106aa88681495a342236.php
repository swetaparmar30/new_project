    ...
    <div class="row"> 
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="row form-sec">
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <input type="text" name="system_setting_title_1" id="setting_title_1" placeholder="Title" data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($system_setting->system_setting_title_1) ? $system_setting->system_setting_title_1 : ''); ?>">
                </div>
            </div>
            <div class="row form-sec">
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 label-sec">
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <input type="text" name="system_sub_title_1" id="system_sub_title_1" placeholder="Title" data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($system_setting->system_sub_title_1) ? $system_setting->system_sub_title_1 : ''); ?>">
                </div>
            </div>
            <div class="row form-sec">
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 label-sec">
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <textarea class="form-control rich-text-editor" id="system_setting_description_2" name="system_setting_description_2" style="height: 300px;"  data-parsley-errors-container="#content_required" data-parsley-required-message="Please Enter Description"><?php echo e(isset($system_setting->system_setting_description_2) ? $system_setting->system_setting_description_2 : ''); ?></textarea>
                    <span id="content_required" class="parsley-required" style="font-weight: 500 !important;"></span>
                </div>
            </div>
             <div class="row form-sec">
            ...
            <div class="row form-sec">
                <label for="">Image 1</label>
                 <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 label-sec">
                    <div class="upload-img-sec">
                        <input type="hidden" name="system_img9" id="system_img9" value="<?php echo e(isset($system_setting->system_img9) ? $system_setting->system_img9 : ''); ?>">
                        <?php if(isset($system_setting->system_img9) && $system_setting->system_img9 != '' && $system_setting->system_img9 != null): ?>
                        <?php
                        $img = App\Models\MediaImage::select('name')->where('id', $system_setting->system_img9)->first();
                        ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="system_avtar9" class="profile-img" > 
                            <a id="remove_system_image9"> <i class="fa fa-times" aria-hidden="true"></i></a>
                        </div>
                        <?php else: ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="system_avtar9" class="profile-img"> 
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="row form-sec">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 label-sec">
                    ...
                    <input type="text" name="title5" id="title5" placeholder="Title" data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($system_setting->title5) ? $system_setting->title5 : ''); ?>">
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <label for="">Icon 5</label>
                    <div class="upload-img-sec">
                        <input type="hidden" name="system_img5" id="system_img5" value="<?php echo e(isset($system_setting->system_img5) ? $system_setting->system_img5 : ''); ?>">
                        <?php if(isset($system_setting->system_img5) && $system_setting->system_img5 != '' && $system_setting->system_img5 != null): ?>
                        <?php
                        $img = App\Models\MediaImage::select('name')->where('id', $system_setting->system_img5)->first();
                        ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="system_avtar5" class="profile-img" > 
                            <a id="remove_system_image5"> <i class="fa fa-times" aria-hidden="true"></i></a>
                        </div>
                        <?php else: ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="system_avtar5" class="profile-img"> 
            ...
            <div class="row form-sec">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 label-sec">
                    ...
                    <input type="text" name="title6" id="title6" placeholder="Title" data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($system_setting->title6) ? $system_setting->title6 : ''); ?>">
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <label for="">Icon 6</label>
                    <div class="upload-img-sec">
                        <input type="hidden" name="system_img6" id="system_img6" value="<?php echo e(isset($system_setting->system_img6) ? $system_setting->system_img6 : ''); ?>">
                        <?php if(isset($system_setting->system_img6) && $system_setting->system_img6 != '' && $system_setting->system_img6 != null): ?>
                        <?php
                        $img = App\Models\MediaImage::select('name')->where('id', $system_setting->system_img6)->first();
                        ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="system_avtar6" class="profile-img" > 
                            <a id="remove_system_image6"> <i class="fa fa-times" aria-hidden="true"></i></a>
                        </div>
                        <?php else: ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="system_avtar6" class="profile-img"> 
            ...
            <div class="row form-sec">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 label-sec">
                    ...
                    <input type="text" name="title7" id="title7" placeholder="Title" data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($system_setting->title7) ? $system_setting->title7 : ''); ?>">
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <label for="">Icon 7</label>
                    <div class="upload-img-sec">
                        <input type="hidden" name="system_img7" id="system_img7" value="<?php echo e(isset($system_setting->system_img7) ? $system_setting->system_img7 : ''); ?>">
                        <?php if(isset($system_setting->system_img7) && $system_setting->system_img7 != '' && $system_setting->system_img7 != null): ?>
                        <?php
                        $img = App\Models\MediaImage::select('name')->where('id', $system_setting->system_img7)->first();
                        ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="system_avtar7" class="profile-img" > 
                            <a id="remove_system_image7"> <i class="fa fa-times" aria-hidden="true"></i></a>
                        </div>
                        <?php else: ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="system_avtar7" class="profile-img"> 
            ...
            <div class="row form-sec">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 label-sec">
                    ...
                    <input type="text" name="title8" id="title8" placeholder="Title" data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($system_setting->title8) ? $system_setting->title8 : ''); ?>">
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <label for="">Icon 8</label>
                    <div class="upload-img-sec">
                        <input type="hidden" name="system_img8" id="system_img8" value="<?php echo e(isset($system_setting->system_img8) ? $system_setting->system_img8 : ''); ?>">
                        <?php if(isset($system_setting->system_img8) && $system_setting->system_img8 != '' && $system_setting->system_img8 != null): ?>
                        <?php
                        $img = App\Models\MediaImage::select('name')->where('id', $system_setting->system_img8)->first();
                        ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="system_avtar8" class="profile-img" > 
                            <a id="remove_system_image8"> <i class="fa fa-times" aria-hidden="true"></i></a>
                        </div>
                        <?php else: ?>
                        <div class="image_preview_div">
                            <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="system_avtar8" class="profile-img"> 
...
<?php /**PATH D:\xampp\htdocs\new_project\resources\views/settings/system_setting_sec.blade.php ENDPATH**/ ?>