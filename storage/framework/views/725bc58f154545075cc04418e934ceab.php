            <div class="row landing-page">
                ...
                <div class="col-xxl-2 col-xl-2 col-lg-4 col-md-6 col-sm-6 col-xs-12 footer-content footer-residential">
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12 footer-content footer-location">
                     <h3>Location</h3>
                     <?php if($slug == 'hastings-garage-doors'): ?>
                    ...
                    <?php elseif($slug == 'lincoln-garage-doors'): ?>
                    ...
                    <div class="social desktop-social-sec landing-page">
                        ...
                        <ul>
                            ...
                            <?php if(Request::is('locations/lincoln-garage-doors')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(Request::is('locations/hastings-garage-doors')): ?>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-12 col-sm-12 col-xs-12 footer-content footer-map">
                    ...
                    <div class="accordion" id="footerAccordion">
                        <?php if($slug == 'lincoln-garage-doors'): ?>
                        ...
                        <?php elseif($slug == 'hastings-garage-doors'): ?>
                            <div class="accordion-item">
            ...
            </div><?php /**PATH C:\xampp\htdocs\Dealer-New\resources\views/frontend/includes/landing-page-footer.blade.php ENDPATH**/ ?>