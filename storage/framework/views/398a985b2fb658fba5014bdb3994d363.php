                        ...
                        <div class="card Recent-Users">
                           ...
                           <div class="card-block px-0 py-3">
                              ...
                              <div class="row form-sec">
                                 ...
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <textarea class="form-control" id="address" name="description" style="height: 300px;" required  data-parsley-required-message="Please Enter Description" data-parsley-errors-container="#content_required" placeholder="Please Enter Description"><?php echo e(isset($faq->description) ? $faq->description : ''); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/faqs/add.blade.php ENDPATH**/ ?>