                                        ...
                                        <div class="card-block px-0 py-3">
                                            ...
                                            <div class="row form-sec" id="page_content_div" <?php if(isset($page->make_with_builder) && $page->make_with_builder == '1'): ?> style="display:none;" <?php endif; ?>>
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    ...
                                                    <textarea class="form-control" id="code_preview0" name="page_content" style="height: 300px;" <?php if(isset($page->make_with_builder) && $page->make_with_builder == '1'): ?> 
                                    ...
                                    <div class="card Recent-Users next-box">
                                        ...
                                        <div class="card-block px-0 py-3">
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea name="meta_description" id="" rows="5" cols="10"><?php echo e(isset($page->meta_description) ? $page->meta_description : ''); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <input type="radio" id="a26" name="publish_status"
                                                            ...
                                                            <?php if(isset($page->publish_status) && $page->publish_status == 'Published'): ?> checked <?php endif; ?> />
                                                        <label class="btn btn-secondary public_status_lable"
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/pages/add.blade.php ENDPATH**/ ?>