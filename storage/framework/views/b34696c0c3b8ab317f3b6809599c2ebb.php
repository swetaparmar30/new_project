                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                         ...
                         <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <label for="">Description 1</label>
                             ...
                             <textarea class="form-control" id="why_choose_description1" name="why_choose_description1" style="height: 300px;"  data-parsley-errors-container="#content_required" data-parsley-required-message="Please Enter Description"><?php echo e(isset($why_choose->why_choose_description1) ? $why_choose->why_choose_description1 : ''); ?></textarea>
                            ...
                            <div class="upload-img-sec">
                                ...
                                <?php if(isset($why_choose->why_choose_img1) && $why_choose->why_choose_img1 != '' && $why_choose->why_choose_img1 != null): ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image1"> <i class="fa fa-times"
                    ...
                    <div class="row form-sec">
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <label for="">Description 2</label>
                             ...
                             <textarea class="form-control" id="why_choose_description2" name="why_choose_description2" style="height: 300px;"  data-parsley-errors-container="#content_required" data-parsley-required-message="Please Enter Description"><?php echo e(isset($why_choose->why_choose_description2) ? $why_choose->why_choose_description2 : ''); ?></textarea>
                            ...
                            <div class="upload-img-sec">
                                ...
                                <?php if(isset($why_choose->why_choose_img2) && $why_choose->why_choose_img2 != '' && $why_choose->why_choose_img2 != null): ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image2"> <i class="fa fa-times"
                    ...
                    <div class="row form-sec">
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <input type="text" name="why_choose_title3" id="why_choose_title3"

                                placeholder="Title" data-parsley-required-message="Please Enter Title"
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <label for="">Description 3</label>
                             ...
                             <textarea class="form-control" id="why_choose_description3" name="why_choose_description3" style="height: 300px;"  data-parsley-errors-container="#content_required" data-parsley-required-message="Please Enter Description"><?php echo e(isset($why_choose->why_choose_description3) ? $why_choose->why_choose_description3 : ''); ?></textarea>
                            ...
                            <div class="upload-img-sec">
                                ...
                                <?php if(isset($why_choose->why_choose_img3) && $why_choose->why_choose_img3 != '' && $why_choose->why_choose_img3 != null): ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image3"> <i class="fa fa-times"
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image3" style="display: none;"> <i
                                ...
                                <label for="" style="cursor: pointer;"
                                    ...
                                    class="choose_file hm-choose-img-title" data-val="why_choose_img3">Choose
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="row form-sec">
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <input type="text" name="why_choose_title4" id="why_choose_title4"
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <label for="">Description 4</label>
                             ...
                             <textarea class="form-control" id="why_choose_description4" name="why_choose_description4" style="height: 300px;"  data-parsley-errors-container="#content_required" data-parsley-required-message="Please Enter Description"><?php echo e(isset($why_choose->why_choose_description4) ? $why_choose->why_choose_description4 : ''); ?></textarea>
                            ...
                            <div class="upload-img-sec">
                                ...
                                <?php if(isset($why_choose->why_choose_img4) && $why_choose->why_choose_img4 != '' && $why_choose->why_choose_img4 != null): ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image4"> <i class="fa fa-times"
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image4" style="display: none;"> <i
                                ...
                                <label for="" style="cursor: pointer;"
                                    ...
                                    class="choose_file hm-choose-img-title" data-val="why_choose_img4">Choose
                    ...
                    <div class="row form-sec">
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <input type="text" name="why_choose_title5" id="why_choose_title5"
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <label for="">Description 5</label>
                             ...
                             <textarea class="form-control" id="why_choose_description5" name="why_choose_description5" style="height: 300px;"  data-parsley-errors-container="#content_required" data-parsley-required-message="Please Enter Description"><?php echo e(isset($why_choose->why_choose_description5) ? $why_choose->why_choose_description5 : ''); ?></textarea>
                            ...
                            <div class="upload-img-sec">
                                ...
                                <?php if(isset($why_choose->why_choose_img5) && $why_choose->why_choose_img5 != '' && $why_choose->why_choose_img5 != null): ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image5"> <i class="fa fa-times"
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image5" style="display: none;"> <i
                                ...
                                <label for="" style="cursor: pointer;"
                                    ...
                                    class="choose_file hm-choose-img-title" data-val="why_choose_img5">Choose
                    ...
                    <div class="row form-sec">
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <input type="text" name="why_choose_title6" id="why_choose_title6"
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                            ...
                            <label for="">Description 6</label>
                             ...
                             <textarea class="form-control" id="why_choose_description6" name="why_choose_description6" style="height: 300px;"  data-parsley-errors-container="#content_required" data-parsley-required-message="Please Enter Description"><?php echo e(isset($why_choose->why_choose_description6) ? $why_choose->why_choose_description6 : ''); ?></textarea>
                            ...
                            <div class="upload-img-sec">
                                ...
                                <?php if(isset($why_choose->why_choose_img6) && $why_choose->why_choose_img6 != '' && $why_choose->why_choose_img6 != null): ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image6"> <i class="fa fa-times"
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="image_preview_div">
                                        ...
                                        <a id="remove_why_choose_image6" style="display: none;"> <i
                                ...
                                <label for="" style="cursor: pointer;"
                                    ...
                                    class="choose_file hm-choose-img-title" data-val="why_choose_img6">Choose
...
<?php /**PATH /home/customer/www/hamzahk13.sg-host.com/public_html/resources/views/settings/why-choose-sec.blade.php ENDPATH**/ ?>