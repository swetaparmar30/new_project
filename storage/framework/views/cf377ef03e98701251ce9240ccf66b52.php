...
<?php $__env->startSection('main_content'); ?>
    ...
    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 label-sec">
        <div class="row form-sec">
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <input type="text" name="meta_keyword" id="meta_keyword" placeholder="Sub Title"
                ...
                <textarea class="form-control" id="meta_description" name="meta_description" style="height: 150px;"
                    ...
                    data-parsley-required-message="Please Enter Description"><?php echo e(isset($loadingdockdoor->meta_description) ? $loadingdockdoor->meta_description : ''); ?></textarea>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" id="description" name="description"><?php echo e(isset($loadingdockdoor->description) ? $loadingdockdoor->description : ''); ?></textarea>
                                                        ...
                                                        <?php if(isset($section3->sec3_image_1) && $section3->sec3_image_1 != '' && $section3->sec3_image_1 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="sec3img1_banner_remove_image"> <i
                                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="sec3img1_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="sec3img1_banner_remove_image"
                                                                    style="display: none;">
                                                                    <i class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php endif; ?>
                                                        ...
                                                        <?php if(isset($section3->sec3_image_2) && $section3->sec3_image_2 != '' && $section3->sec3_image_2 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="sec3img2_banner_remove_image"> <i
                                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="sec3img2_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="sec3img2_banner_remove_image"
                                                                    style="display: none;">
                                                                    <i class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php endif; ?>
                                                        ...
                                                        <?php if(isset($section3->sec3_image_3) && $section3->sec3_image_3 != '' && $section3->sec3_image_3 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="sec3img3_banner_remove_image"> <i
                                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="sec3img3_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="sec3img3_banner_remove_image"
                                                                    style="display: none;">
                                                                    <i class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php endif; ?>
                                                        ...
                                                        <?php if(isset($section3->sec3_image_4) && $section3->sec3_image_4 != '' && $section3->sec3_image_4 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="sec3img4_banner_remove_image"> <i
                                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="sec3img4_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="sec3img4_banner_remove_image"
                                                                    style="display: none;">
                                                                    <i class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk13.sg-host.com/public_html/resources/views/loadingdock/index.blade.php ENDPATH**/ ?>