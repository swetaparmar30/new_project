        ...
        <div class="pcoded-inner-content">
            ...
            <div class="main-body">
                <div class="page-wrapper">
                    <!-- [ Main Content ] start -->
                                <form action="<?php echo e(route('email.setting.add')); ?>" method="POST" data-parsley-validate=""
                                        ...
                                        <div class="row form-sec">
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 label-sec">
                                                <input type="hidden" name="emailsetting_id"
                                                    value="<?php echo e(isset($email->id) ? $email->id : ''); ?>">
                                            ...
                                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                ...
                                                data-parsley-required-message="Please Enter Mailer" value="<?php echo e(isset($email->transport) ? $email->transport : ''); ?>">
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 label-sec">
                                            ...
                                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                ...
                                                data-parsley-required-message="Please Enter Mail Host" value="<?php echo e(isset($email->host) ? $email->host : ''); ?>">
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 label-sec">
                                            ...
                                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                ...
                                                data-parsley-required-message="Please Enter Mail Port" value="<?php echo e(isset($email->port) ? $email->port : ''); ?>" placeholder="Mail Port">
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 label-sec">
                                            ...
                                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                ...
                                                data-parsley-required-message="Please Enter Mail Username" value="<?php echo e(isset($email->username) ? $email->username : ''); ?>" >
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 label-sec">
                                            ...
                                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                ...
                                                data-parsley-required-message="Please Enter Mail Password" value="<?php echo e(isset($email->password) ? $email->password : ''); ?>" >
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 label-sec">
                                            ...
                                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                ...
                                                data-parsley-required-message="Please Enter Mail Encryption" value="<?php echo e(isset($email->encryption) ? $email->encryption : ''); ?>" >
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 label-sec">
                                            ...
                                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                ...
                                                data-parsley-required-message="Please Enter Mail From Address" value="<?php echo e(isset($email->from_address) ? $email->from_address : ''); ?>" >
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 label-sec">
                                            ...
                                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                ...
                                                data-parsley-required-message="Please Enter Mail From Name" value="<?php echo e(isset($email->from_name) ? $email->from_name : ''); ?>" >
                                            </div>
                                        </div>
