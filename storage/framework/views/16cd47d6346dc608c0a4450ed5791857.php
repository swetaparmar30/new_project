                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                                            <form id="addtags" action="<?php echo e(route('tags.save')); ?>" method="POST"
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).on('change', '#name', function(e) {
            ...
            var val = $(this).val();
            $.ajax({
                url: "<?php echo e(route('tag.check_slug')); ?>",
                method: "POST",
                data: {
                    _token: token,
                    name: val
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/tags/index.blade.php ENDPATH**/ ?>