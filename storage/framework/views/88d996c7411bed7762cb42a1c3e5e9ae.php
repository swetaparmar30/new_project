                                    ...
                                    <div class="section-list">
                                        ...
                                        <div class ="row p-10 full_section" id="section_<?php echo e($val->id); ?>"
                                            ...
                                            <div class="row my-2 mx-0 col-11 bg-white layout-height">
                                                ...
                                                data-order="<?php echo e($index2 + 1); ?>">
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/pages/builder_section.blade.php ENDPATH**/ ?>