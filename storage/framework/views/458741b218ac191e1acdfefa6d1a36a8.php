                                ...
                                <div class="card Recent-Users next-box">
                                    ...
                                    <div class="card-block px-0 py-3">
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                <textarea class="form-control" name="mv_description_1" id="" rows="5" cols="10"><?php echo e(isset($mission_values->mv_description_1) ? $mission_values->mv_description_1 : ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                <textarea class="form-control" name="mv_description_2" id="" rows="5" cols="10"><?php echo e(isset($mission_values->mv_description_2) ? $mission_values->mv_description_2 : ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                <textarea class="form-control" name="mv_description_3" id="" rows="5" cols="10"><?php echo e(isset($mission_values->mv_description_3) ? $mission_values->mv_description_3 : ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                <textarea class="form-control" name="mv_description_4" id="" rows="5" cols="10"><?php echo e(isset($mission_values->mv_description_4) ? $mission_values->mv_description_4 : ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                <textarea class="form-control" name="mv_description_5" id="" rows="5" cols="10"><?php echo e(isset($mission_values->mv_description_5) ? $mission_values->mv_description_5 : ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                <textarea class="form-control" name="mv_description_6" id="" rows="5" cols="10"><?php echo e(isset($mission_values->mv_description_6) ? $mission_values->mv_description_6 : ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                            <div
                                ...
                                <div class="card Recent-Users next-box">
                                    ...
                                    <div class="card-block px-0 py-3">
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                <textarea class="form-control" name="our_history_desc" id="our_history_desc" rows="5" cols="10"><?php echo e(isset($about->our_history_desc) ? $about->our_history_desc : ''); ?></textarea>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk13.sg-host.com/public_html/resources/views/about/index.blade.php ENDPATH**/ ?>