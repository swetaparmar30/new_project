    ...
    <div>
        ...
        <div class="btn-group" data-toggle="buttons">
            <label class="btn btn-primary sm active gallery_column_lable">
                ...
                <img src="<?php echo e(asset('assets/images/1column.png')); ?>" class="img-fluid">
            </label>
            <label class="btn btn-primary sm gallery_column_lable">
                <input type="radio" class="d-none" name="g_column"  value="col-6">
                <img src="<?php echo e(asset('assets/images/2column.png')); ?>" class="img-fluid">
            </label>
            <label class="btn btn-primary sm gallery_column_lable">
                <input type="radio" class="d-none" name="g_column"  value="col-4">
                <img src="<?php echo e(asset('assets/images/3column.png')); ?>" class="img-fluid">
            </label>
        </div>
    </div>
    <div class="form-group">
...
<?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/pages/widgets_html/our_gallery.blade.php ENDPATH**/ ?>