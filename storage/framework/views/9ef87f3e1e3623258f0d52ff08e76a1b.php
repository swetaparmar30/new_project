            ...
            <div class="row align-items-center">
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 services-sec">
                    ...
                    <?php if(!empty($service_head_sec->service_head_description)): ?>
                        <p><?php echo $service_head_sec->service_head_description; ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Clark_Dynamic_site_DEC\resources\views/frontend/includes/services-sec.blade.php ENDPATH**/ ?>