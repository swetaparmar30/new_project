                                        ...
                                        <div class="row">
                                                ...
                                                <div class="card-body nav-sidebar">
                                                    <div class="list-group">
                                                        <?php $__currentLoopData = $listsitemaps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="list-group-item list-group-item-action list-group-item-light sitemap-edit <?php echo e($index === 0 ? 'active' : ''); ?>"
                                                                data-id="<?php echo e($index); ?>"
                                                                data-type="<?php echo e($list->type); ?>">
                                            ...
                                            <div class="col-12 col-md-9 second-right p-0">
                                                ...
                                                <div id="html-sitemap-section" style="display: none;">
                                                    <form id="myform" action="<?php echo e(route('sitemapsetting.storeupdate')); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <div id="page-sitemap-section" style="display: none;">
                                                    <form action="<?php echo e(route('sitemapsetting.storeupdate')); ?>" method="POST"
                                                        id="myform1">
                                                        <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="row align-items-center mb-5">
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" type="text"
                                                                        value="Sitemap URL: <?php echo e(route('pagefront.xml')); ?>"
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                $displayName =
                                                                                    $path === ''
                                                                                        ...
                                                                                        : str_replace('-', ' ', $path);
                                                                            ?>
                                                                            <option value="<?php echo e($pageUrl); ?>">
                                                                                <?php echo e($displayName); ?></option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                $displayName =
                                                                                    $path === ''
                                                                                        ...
                                                                                        : str_replace('-', ' ', $path);
                                                                            ?>
                                                                            <option value="<?php echo e($residentialUrl); ?>">
                                                                                <?php echo e($displayName); ?></option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                </div>
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                $displayName =
                                                                                    $path === ''
                                                                                        ...
                                                                                        : str_replace('-', ' ', $path);
                                                                            ?>
                                                                            <option value="<?php echo e($commercialUrl); ?>">
                                                                                <?php echo e($displayName); ?></option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="row form-sec">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input class="form-control" id="meta_title"
                                                                            name="meta_title"  value="<?php echo e(isset($sitemapPages->meta_title) ? $sitemapPages->meta_title : ''); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div class="row form-sec">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input class="form-control" id="meta_keyword"
                                                                            name="meta_keyword"  value="<?php echo e(isset($sitemapPages->meta_keyword) ? $sitemapPages->meta_keyword : ''); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div class="row form-sec">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <textarea class="form-control" id="meta_description" name="meta_description" style="height: 150px;"
                                                                            data-parsley-errors-container="#content_required1" data-parsley-required-message="Please Enter Description"><?php echo e(isset($sitemapPages->meta_description) ? $sitemapPages->meta_description : ''); ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div id="post-sitemap-section" style="display: none;">
                                                    <form id="postform"
                                                        action="<?php echo e(route('sitemapsetting.storeupdate')); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="card-body card-inner">
                                                            <div class="row align-items-center mb-5">
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" type="text"
                                                                        value="Sitemap URL: <?php echo e(route('postfront.xml')); ?>"
                                                                        disabled style="border-left: 5px solid #8b8b8b;">
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-sm-12 select-border-line">
                                                                    <select class="form-select select2" name="post[]"
                                                                        ...
                                                                        <?php $__currentLoopData = $blogSitemap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option value="<?php echo e($blog['url']); ?>">
                                                                                <?php echo e($blog['title']); ?></option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="row form-sec">
                                                                    ...
                                                                    <div
                                                                        class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <input class="form-control" id="meta_title"
                                                                            name="meta_title"  value="<?php echo e(isset($sitemapPosts->meta_title) ? $sitemapPosts->meta_title : ''); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div class="row form-sec">
                                                                    ...
                                                                    <div
                                                                        class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <input class="form-control" id="meta_keyword"
                                                                            name="meta_keyword"  value="<?php echo e(isset($sitemapPosts->meta_keyword) ? $sitemapPosts->meta_keyword : ''); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div class="row form-sec">
                                                                    ...
                                                                    <div
                                                                        class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <textarea class="form-control" id="meta_description" name="meta_description" style="height: 150px;"
                                                                            data-parsley-errors-container="#content_required1" data-parsley-required-message="Please Enter Description"><?php echo e(isset($sitemapPosts->meta_description) ? $sitemapPosts->meta_description : ''); ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dealer-New\resources\views/sitemap-setting/index.blade.php ENDPATH**/ ?>