                           ...
                           <div class="card-block px-0 py-3">
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <input type="hidden" name="title" value="<?php echo e(isset($about->title) ? $about->title : ''); ?>">
                                    <label for="title">About Page Title <span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" name="title" id="title" placeholder="About Page Title" required
                                       data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($about->title) ? $about->title : ''); ?>">
                                 </div>
                              </div>
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <label for="description">Description <span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <textarea class="form-control" id="description" name="description" style="height: 150px;" data-parsley-required="true" data-parsley-required-message="Please enter Description" data-parsley-errors-container="#description_required"><?php echo e(isset($about->description) ? $about->description : ''); ?></textarea>
                                    <span id="description_required"></span>
                                 </div>
                              </div>
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <input type="hidden" name="missiontitle" value="<?php echo e(isset($about->missiontitle) ? $about->missiontitle : ''); ?>">
                                    <label for="missiontitle">Section 2 Title <span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" name="missiontitle" id="missiontitle" placeholder="About Page Title" required
                                       data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($about->missiontitle) ? $about->missiontitle : ''); ?>">
                                 </div>
                              </div>
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <label for="missiondescription">Section 2 Description <span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <textarea class="form-control" id="missiondescription" name="missiondescription" style="height: 150px;" data-parsley-required="true" data-parsley-required-message="Please enter Description" data-parsley-errors-container="#missiondescription_required"><?php echo e(isset($about->missiondescription) ? $about->missiondescription : ''); ?></textarea>
                                    <span id="missiondescription_required"></span>
                                 </div>
                              </div>
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <input type="hidden" name="missionbutton" value="<?php echo e(isset($about->missionbutton) ? $about->missionbutton : ''); ?>">
                                    <label for="missionbutton">Section 2 Button <span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" name="missionbutton" id="missionbutton" placeholder="Button Name" 
                                       data-parsley-required-message="Please Enter Button Title" value="<?php echo e(isset($about->missionbutton) ? $about->missionbutton : ''); ?>">
                                 </div>
                              </div>
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <input type="hidden" name="missionbuttonurl" value="<?php echo e(isset($about->missionbuttonurl) ? $about->missionbuttonurl : ''); ?>">
                                    <label for="missionbuttonurl">Section 2 Button Url<span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" name="missionbuttonurl" id="missionbuttonurl" placeholder="Button URL" 
                                       data-parsley-required-message="Please Enter Url" value="<?php echo e(isset($about->missionbuttonurl) ? $about->missionbuttonurl : ''); ?>">
                                 </div>
                              </div>
                              <!-- <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                              ...
                              <!-- <div class="row form-sec">
                                 ...
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <textarea class="form-control" id="teamdescription" name="teamdescription" style="height: 150px;" data-parsley-required="true" data-parsley-required-message="Please enter Description" data-parsley-errors-container="#teamdescription_required"><?php echo e(isset($about->teamdescription) ? $about->teamdescription : ''); ?></textarea>
                              ...
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <input type="hidden" name="historytitle" value="<?php echo e(isset($about->historytitle) ? $about->historytitle : ''); ?>">
                                    <label for="historytitle">History Section Title <span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" name="historytitle" id="historytitle" placeholder="History Section Title" required
                                       data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($about->historytitle) ? $about->historytitle : ''); ?>">
                                 </div>
                              </div>
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <input type="hidden" name="historysubtitle" value="<?php echo e(isset($about->historysubtitle) ? $about->historysubtitle : ''); ?>">
                                    <label for="historysubtitle">History Section Title <span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" name="historysubtitle" id="historysubtitle" placeholder="History Section Title" required
                                       data-parsley-required-message="Please Enter Title" value="<?php echo e(isset($about->historysubtitle) ? $about->historysubtitle : ''); ?>">
                                 </div>
                              </div>
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <label for="historydescription">History Section Description <span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <textarea class="form-control" id="historydescription" name="historydescription" style="height: 150px;" data-parsley-required="true" data-parsley-required-message="Please enter Description" data-parsley-errors-container="#historydescription_required"><?php echo e(isset($about->historydescription) ? $about->historydescription : ''); ?></textarea>
                                    <span id="historydescription_required"></span>
                                 </div>
                              </div>
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <input type="hidden" name="historybutton" value="<?php echo e(isset($about->historybutton) ? $about->historybutton : ''); ?>">
                                    <label for="historybutton">Section 4 Button <span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" name="historybutton" id="historybutton" placeholder="Button Name" 
                                       data-parsley-required-message="Please Enter Button Title" value="<?php echo e(isset($about->historybutton) ? $about->historybutton : ''); ?>">
                                 </div>
                              </div>
                              <div class="row form-sec">
                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    <input type="hidden" name="historybuttonurl" value="<?php echo e(isset($about->historybuttonurl) ? $about->historybuttonurl : ''); ?>">
                                    <label for="historybuttonurl">Section 4 Button Url<span style="color: red;margin: 0;">*</span></label>
                                 </div>
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <input type="text" name="historybuttonurl" id="historybuttonurl" placeholder="Button URL" 
                                       data-parsley-required-message="Please Enter Url" value="<?php echo e(isset($about->historybuttonurl) ? $about->historybuttonurl : ''); ?>">
                                 </div>
                              </div>
                        ...
                        <div class="card Recent-Users next-box">
                           ...
                           <div class="card-block px-0 py-3">
                              ...
                              <div class="row form-sec">
                                 ...
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="upload-img-sec">
                                       <input type="hidden" name="mv_icon_1" id="mv_icon_1" value="<?php echo e(isset($mission_values->mv_icon_1) ? $mission_values->mv_icon_1 : ''); ?>">
                                       <?php if(isset($mission_values->mv_icon_1) && $mission_values->mv_icon_1 != '' && $mission_values->mv_icon_1 != null): ?>
                                       <?php
                                       $img = App\Models\MediaImage::select('name')->where('id', $mission_values->mv_icon_1)->first();
                                       ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="mvicon1_banner_avtar" class="profile-img" > 
                                          <a id="mvicon1_banner_remove_image"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php else: ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="mvicon1_banner_avtar" class="profile-img"> 
                                          <a id="mvicon1_banner_remove_image" style="display: none;"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php endif; ?>
                                       <label for="" style="cursor: pointer;" class="choose_file hm-choose-img-title" data-val="mv_icon_1">Choose image</label>
                                       <?php if(isset($mission_values->mv_icon_1) && $mission_values->mv_icon_1 != '' && $mission_values->mv_icon_1 != null): ?>
                                       <?php else: ?>
                              ...
                              <div class="row form-sec">
                                 ...
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="upload-img-sec">
                                       <input type="hidden" name="mv_icon_2" id="mv_icon_2" value="<?php echo e(isset($mission_values->mv_icon_2) ? $mission_values->mv_icon_2 : ''); ?>">
                                       <?php if(isset($mission_values->mv_icon_2) && $mission_values->mv_icon_2 != '' && $mission_values->mv_icon_2 != null): ?>
                                       <?php
                                       $img = App\Models\MediaImage::select('name')->where('id', $mission_values->mv_icon_2)->first();
                                       ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="mvicon2_banner_avtar" class="profile-img" > 
                                          <a id="mvicon2_banner_remove_image"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php else: ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="mvicon2_banner_avtar" class="profile-img"> 
                                          <a id="mvicon2_banner_remove_image" style="display: none;"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php endif; ?>
                                       <label for="" style="cursor: pointer;" class="choose_file hm-choose-img-title" data-val="mv_icon_2">Choose image</label>
                                       <?php if(isset($mission_values->mv_icon_2) && $mission_values->mv_icon_2 != '' && $mission_values->mv_icon_2 != null): ?>
                                       <?php else: ?>
                                       <span id="img_alert1" class="parsley-required" style="font-weight: 500 !important;color: red !important;"></span>
                                       <?php endif; ?>
                              ...
                              <div class="row form-sec">
                                 ...
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="upload-img-sec">
                                       <input type="hidden" name="mv_icon_3" id="mv_icon_3" value="<?php echo e(isset($mission_values->mv_icon_3) ? $mission_values->mv_icon_3 : ''); ?>">
                                       <?php if(isset($mission_values->mv_icon_3) && $mission_values->mv_icon_3 != '' && $mission_values->mv_icon_3 != null): ?>
                                       <?php
                                       $img = App\Models\MediaImage::select('name')->where('id', $mission_values->mv_icon_3)->first();
                                       ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="mvicon3_banner_avtar" class="profile-img" > 
                                          <a id="mvicon3_banner_remove_image"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php else: ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="mvicon3_banner_avtar" class="profile-img"> 
                                          <a id="mvicon3_banner_remove_image" style="display: none;"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php endif; ?>
                                       <label for="" style="cursor: pointer;" class="choose_file hm-choose-img-title" data-val="mv_icon_3">Choose image</label>
                                       <?php if(isset($mission_values->mv_icon_3) && $mission_values->mv_icon_3 != '' && $mission_values->mv_icon_3 != null): ?>
                                       <?php else: ?>
                                       <span id="img_alert1" class="parsley-required" style="font-weight: 500 !important;color: red !important;"></span>
                                       <?php endif; ?>
                              ...
                              <div class="row form-sec">
                                 ...
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="upload-img-sec">
                                       <input type="hidden" name="mv_icon_4" id="mv_icon_4" value="<?php echo e(isset($mission_values->mv_icon_4) ? $mission_values->mv_icon_4 : ''); ?>">
                                       <?php if(isset($mission_values->mv_icon_4) && $mission_values->mv_icon_4 != '' && $mission_values->mv_icon_4 != null): ?>
                                       <?php
                                       $img = App\Models\MediaImage::select('name')->where('id', $mission_values->mv_icon_4)->first();
                                       ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="mvicon4_banner_avtar" class="profile-img" > 
                                          <a id="mvicon4_banner_remove_image"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php else: ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="mvicon4_banner_avtar" class="profile-img"> 
                                          <a id="mvicon4_banner_remove_image" style="display: none;"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php endif; ?>
                                       <label for="" style="cursor: pointer;" class="choose_file hm-choose-img-title" data-val="mv_icon_4">Choose image</label>
                                       <?php if(isset($mission_values->mv_icon_4) && $mission_values->mv_icon_4 != '' && $mission_values->mv_icon_4 != null): ?>
                                       <?php else: ?>
                                       <span id="img_alert1" class="parsley-required" style="font-weight: 500 !important;color: red !important;"></span>
                                       <?php endif; ?>
                              ...
                              <div class="row form-sec">
                                 ...
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="upload-img-sec">
                                       <input type="hidden" name="mv_icon_5" id="mv_icon_5" value="<?php echo e(isset($mission_values->mv_icon_5) ? $mission_values->mv_icon_5 : ''); ?>">
                                       <?php if(isset($mission_values->mv_icon_5) && $mission_values->mv_icon_5 != '' && $mission_values->mv_icon_5 != null): ?>
                                       <?php
                                       $img = App\Models\MediaImage::select('name')->where('id', $mission_values->mv_icon_5)->first();
                                       ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="mvicon5_banner_avtar" class="profile-img" > 
                                          <a id="mvicon5_banner_remove_image"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php else: ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="mvicon5_banner_avtar" class="profile-img"> 
                                          <a id="mvicon5_banner_remove_image" style="display: none;"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php endif; ?>
                                       <label for="" style="cursor: pointer;" class="choose_file hm-choose-img-title" data-val="mv_icon_5">Choose image</label>
                                       <?php if(isset($mission_values->mv_icon_5) && $mission_values->mv_icon_5 != '' && $mission_values->mv_icon_5 != null): ?>
                                       <?php else: ?>
                                       <span id="img_alert1" class="parsley-required" style="font-weight: 500 !important;color: red !important;"></span>
                                       <?php endif; ?>
                              ...
                              <div class="row form-sec">
                                 ...
                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="upload-img-sec">
                                       <input type="hidden" name="mv_icon_6" id="mv_icon_6" value="<?php echo e(isset($mission_values->mv_icon_6) ? $mission_values->mv_icon_6 : ''); ?>">
                                       <?php if(isset($mission_values->mv_icon_6) && $mission_values->mv_icon_6 != '' && $mission_values->mv_icon_6 != null): ?>
                                       <?php
                                       $img = App\Models\MediaImage::select('name')->where('id', $mission_values->mv_icon_6)->first();
                                       ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('uploads/'.$img->name)); ?>" alt="" id="mvicon6_banner_avtar" class="profile-img" > 
                                          <a id="mvicon6_banner_remove_image"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php else: ?>
                                       <div class="image_preview_div">
                                          <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>" alt="" id="mvicon6_banner_avtar" class="profile-img"> 
                                          <a id="mvicon6_banner_remove_image" style="display: none;"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                       </div>
                                       <?php endif; ?>
                                       <label for="" style="cursor: pointer;" class="choose_file hm-choose-img-title" data-val="mv_icon_6">Choose image</label>
                                       <?php if(isset($mission_values->mv_icon_6) && $mission_values->mv_icon_6 != '' && $mission_values->mv_icon_6 != null): ?>
                                       <?php else: ?>
                                       <span id="img_alert1" class="parsley-required" style="font-weight: 500 !important;color: red !important;"></span>
                                       <?php endif; ?>
                              ...
                              <div class="row form-sec">
                                 <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 label-sec">
                                    <div class="upload-img-sec text-center image_preview_div">
                                       <input type="hidden" name="bannerimage" id="img_id" value="<?php echo e(isset($about->bannerimage) ? $about->bannerimage : ''); ?>" data-parsley-errors-container="#site_img_required"data-parsley-trigger="change" data-parsley-required-message="Please choose an image.">
                              ...
                              <div class="row form-sec">
                                 <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 label-sec">
                                    <div class="upload-img-sec text-center">
                                       <input type="hidden" name="teambackground" id="footer_img_id" value="<?php echo e(isset($about->teambackground) ? $about->teambackground : ''); ?>" data-parsley-errors-container="#teambackground_img_required"data-parsley-trigger="change" data-parsley-required-message="Please choose an image.">
                        ...
                        <div class="card Recent-Users next-box" style="margin-top: 0 !important;">
                           ...
                           <div class="card-block px-0 py-3">
                              <div class="row form-sec">
                                 <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 label-sec">
                                    <div class="upload-img-sec text-center">
                                       <input type="hidden" name="historyimage" id="favicon_id" value="<?php echo e(isset($about->historyimage) ? $about->historyimage : ''); ?>" required data-parsley-errors-container="#site_favicon_img_required" data-parsley-trigger="change" data-parsley-required-message="Please choose an image.">
