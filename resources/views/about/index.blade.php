                        ...
                        <form action="{{ route('about.add') }}" method="POST" data-parsley-validate=""
                            ...
                            <div class="row">
                                <div
                                        ...
                                        <div class="card-block px-0 py-3">
                                            ...
                                            <!-- <div class="row form-sec">
                                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                                    <input type="hidden" name="teamtitle" value="{{ isset($about->teamtitle) ? $about->teamtitle : '' }}">
                                                 ...
                                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="teamtitle" id="teamtitle" placeholder="Team Section Title" required
                                                       data-parsley-required-message="Please Enter Team Section Title" value="{{ isset($about->teamtitle) ? $about->teamtitle : '' }}">
                                                 </div>
                                              </div> -->
                                            <!-- <div class="row form-sec">
                                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                                 ...
                                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" id="teamdescription" name="teamdescription" style="height: 150px;"
                                                        data-parsley-required="true" data-parsley-required-message="Please enter Description"
                                                        data-parsley-errors-container="#teamdescription_required">{{ isset($about->teamdescription) ? $about->teamdescription : '' }}</textarea>
                                                    <span id="teamdescription_required"></span>
                                                 </div>
                                              </div> -->
                                            <!-- <div class="row form-sec">
                                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                                    <input type="hidden" name="button1" value="{{ isset($about->button1) ? $about->button1 : '' }}">
                                                 ...
                                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="button1" id="button1" placeholder="Button Name"
                                                       data-parsley-required-message="Please Enter Button Title" value="{{ isset($about->button1) ? $about->button1 : '' }}">
                                                 </div>
                                              </div> -->
                                            <!-- <div class="row form-sec">
                                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                                    <input type="hidden" name="button1url" value="{{ isset($about->button1url) ? $about->button1url : '' }}">
                                                 ...
                                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="button1url" id="button1url" placeholder="Button URL"
                                                       data-parsley-required-message="Please Enter Url" value="{{ isset($about->button1url) ? $about->button1url : '' }}">
                                                 </div>
                                              </div> -->
                                            <!-- <div class="row form-sec">
                                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                                    <input type="hidden" name="button2" value="{{ isset($about->button2) ? $about->button2 : '' }}">
                                                 ...
                                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="button2" id="button2" placeholder="Button Name"
                                                       data-parsley-required-message="Please Enter Button Title" value="{{ isset($about->button2) ? $about->button2 : '' }}">
                                                 </div>
                                              </div> -->
                                            <!-- <div class="row form-sec">
                                                 <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                                    <input type="hidden" name="button2url" value="{{ isset($about->button2url) ? $about->button2url : '' }}">
                                                 ...
                                                 <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="button2url" id="button2url" placeholder="Button URL"
                                                       data-parsley-required-message="Please Enter Url" value="{{ isset($about->button2url) ? $about->button2url : '' }}">
                                                 </div>
                                              </div> -->
                                            <div class="row form-sec">
                                                <div
                                                    ...
                                                    <input type="hidden" name="historytitle"
                                                        value="{{ isset($about->historytitle) ? $about->historytitle : '' }}">
                                    ...
                                    <div class="card Recent-Users next-box" @if (in_array(auth()->user()->role, ['dealer'])) style="display:none" @endif>
                                        <h5>Meta Tags</h5>
                                        <div class="card-block px-0 py-3">
                                            <div class="row form-sec">
                                                <div
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" id="meta_description" name="meta_description" style="height: 150px;"
                                                        data-parsley-errors-container="#content_required1" data-parsley-required-message="Please Enter Description" placeholder="Meta Description">{{ isset($about->meta_description) ? $about->meta_description : '' }}</textarea>
                                                </div>
                                            </div>
                                        </div>
