                                    ...
                                    <div class="card Recent-Users">
                                        ...
                                        <div class="card-block px-0 py-3">
                                            ...
                                            <div class="row form-sec"
                                                @if (in_array(auth()->user()->role, ['dealer', 'marketing'])) style="display:none" @endif>
                                                <div
                                            ...
                                            <div @if (in_array(auth()->user()->role, ['dealer'])) style="display:none" @endif>
                                                <div class="row form-sec">
                                                    <div
                                                        class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                               ...
                                               data-parsley-required-message="Please Enter Location" value="{{ isset($setting->location) ? $setting->location : '' }}" > -->
                                                        <textarea class="form-control rich-text-editor" id="location2" name="location2" style="height: 150px;"
                                                            data-parsley-required="true" data-parsley-required-message="Please enter Address"
                                                            data-parsley-errors-container="#address_required">{{ isset($setting->location2) ? $setting->location2 : '' }}</textarea>
                                                        <span id="address_required"></span>
                                                    </div>
                                                </div>
                                                <div class="row form-sec">
                                               ...
                                               data-parsley-required-message="Please Enter Location" value="{{ isset($setting->location) ? $setting->location : '' }}" > -->
                                                        <textarea class="form-control rich-text-editor" id="location3" name="location3" style="height: 150px;"
                                                            data-parsley-required="true" data-parsley-required-message="Please enter Address"
                                                            data-parsley-errors-container="#address_required">{{ isset($setting->location3) ? $setting->location3 : '' }}</textarea>
                                                        <span id="address_required"></span>
                                                    </div>
                                                </div>
                                                <div class="row form-sec">
                                               ...
                                               data-parsley-required-message="Please Enter Location" value="{{ isset($setting->location) ? $setting->location : '' }}" > -->
                                                        <textarea class="form-control rich-text-editor" id="location4" name="location4" style="height: 150px;"
                                                            data-parsley-required="true" data-parsley-required-message="Please enter Address"
                                                            data-parsley-errors-container="#address_required">{{ isset($setting->location4) ? $setting->location4 : '' }}</textarea>
                                                        <span id="address_required"></span>
                                                    </div>
                                                </div>
                                                <div class="row form-sec">
                                                ...
                                                <div class="row form-sec">
                                                    ...
                                                    <div
                                                        ...
                                                        <textarea class="form-control rich-text-editor" id="map_link2" name="map_link2" style="height: 150px;"
                                                            ...
                                                            data-parsley-errors-container="#map_link2_required">{{ isset($setting->map_link2) ? $setting->map_link2 : '' }}</textarea>
                                                ...
                                                {{-- <div class="row form-sec">
                                                    ...
                                                    <div
                                                        ...
                                                        <textarea class="form-control rich-text-editor" id="map_link3" name="map_link3" style="height: 150px;" data-parsley-required="true"
                                                            data-parsley-required-message="Please Enter Map Link 3" data-parsley-errors-container="#map_link3_required">{{ isset($setting->map_link3) ? $setting->map_link3 : '' }}</textarea>
                                                ...
                                                <div class="row form-sec">
                                                    ...
                                                    <div
                                                        ...
                                                        <textarea class="form-control rich-text-editor" id="map_link4" name="map_link4" style="height: 150px;" data-parsley-required="true"
                                                            data-parsley-required-message="Please Enter Map Link 4" data-parsley-errors-container="#map_link4_required">{{ isset($setting->map_link4) ? $setting->map_link4 : '' }}</textarea>
                                                ...
                                                <div class="row form-sec">
                                                    ...
                                                    <div
                                                        ...
                                                        <textarea class="form-control rich-text-editor" id="code_preview0" name="content" style="height: 300px;"
                                                            ...
                                                            data-parsley-errors-container="#content_required">{{ isset($setting->content) ? $setting->content : '' }}</textarea>
                                         ...
                                         <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                            ...
                                            <div class="row form-sec"
                                                @if (in_array(auth()->user()->role, ['dealer'])) style="display:none" @endif>
                                                <div
                                                    class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                                    <label for="">Copyright Text </label>
                                                </div>
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" id="copyright" name="copyright" style="height: 200px;">{{ isset($setting->copyright) ? $setting->copyright : '' }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec"
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" id="meta_description" name="meta_description" style="height: 150px;"
                                                        data-parsley-errors-container="#content_required1" data-parsley-required-message="Please Enter Description">{{ isset($setting->meta_description) ? $setting->meta_description : '' }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <select name="monday_choose">
                                                        <option value="open" {{ isset($m_opend) ? 'selected' : '' }}>
                                                            Open</option>
                                                        <option value="close"
                                                            {{ isset($setting->monday) && $setting->monday == 'closed' ? 'selected' : '' }}>
                                                            Closed</option>
                                                    </select>
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="monday_form2" id="monday_form2"
                                                        placeholder="From"
                                                        value="{{ isset($m_json->from2) ? $m_json->from2 : '' }}">
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="monday_to2" id="monday_to2"
                                                        placeholder="To"
                                                        value="{{ isset($m_json->to2) ? $m_json->to2 : '' }}">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <select name="tuesday_choose">
                                                        <option value="open" {{ isset($t_opend) ? 'selected' : '' }}>
                                                            Open</option>
                                                        <option value="close"
                                                            {{ isset($setting->tuesday) && $setting->tuesday == 'closed' ? 'selected' : '' }}>
                                                            Closed</option>
                                                    </select>
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="tuesday_form2" id="tuesday_form2"
                                                        placeholder="From"
                                                        value="{{ isset($t_json->from2) ? $t_json->from2 : '' }}">
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="tuesday_to2" id="tuesday_to2"
                                                        placeholder="To"
                                                        value="{{ isset($t_json->to2) ? $t_json->to2 : '' }}">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <select name="wedsday_choose">
                                                        <option value="open" {{ isset($w_opend) ? 'selected' : '' }}>
                                                            Open</option>
                                                        <option value="close"
                                                            {{ isset($setting->wedsday) && $setting->wedsday == 'closed' ? 'selected' : '' }}>
                                                            Closed</option>
                                                    </select>
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="wed_form2" id="wed_form2"
                                                        placeholder="From"
                                                        value="{{ isset($w_json->from2) ? $w_json->from2 : '' }}">
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="wed_to2" id="wed_to2" placeholder="To"
                                                        value="{{ isset($w_json->to2) ? $w_json->to2 : '' }}">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <select name="thursday_choose">
                                                        <option value="open" {{ isset($th_opend) ? 'selected' : '' }}>
                                                            Open</option>
                                                        <option value="close"
                                                            {{ isset($setting->thursday) && $setting->thursday == 'closed' ? 'selected' : '' }}>
                                                            Closed</option>
                                                    </select>
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="thur_form2" id="thur_form2"
                                                        placeholder="From"
                                                        value="{{ isset($th_json->from2) ? $th_json->from2 : '' }}">
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="thur_to2" id="thur_to2"
                                                        placeholder="To"
                                                        value="{{ isset($th_json->to2) ? $th_json->to2 : '' }}">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <select name="friday_choose">
                                                        <option value="open" {{ isset($f_opend) ? 'selected' : '' }}>
                                                            Open</option>
                                                        <option value="close"
                                                            {{ isset($setting->friday) && $setting->friday == 'closed' ? 'selected' : '' }}>
                                                            Closed</option>
                                                    </select>
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="friday_form2" id="friday_form2"
                                                        placeholder="From"
                                                        value="{{ isset($f_json->from2) ? $f_json->from2 : '' }}">
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="friday_to2" id="friday_to2"
                                                        placeholder="To"
                                                        value="{{ isset($f_json->to2) ? $f_json->to2 : '' }}">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <select name="sat_sun_choose">
                                                        <option value="open" {{ isset($st_opend) ? 'selected' : '' }}>
                                                            Open</option>
                                                        <option value="close"
                                                            {{ isset($setting->sat_sun) && $setting->sat_sun == 'closed' ? 'selected' : '' }}>
                                                            Closed</option>
                                                    </select>
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="sat_sun_form2" id="sat_sun_form"
                                                        placeholder="From"
                                                        value="{{ isset($s_json->from2) ? $s_json->from2 : '' }}">
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="sat_sun_to2" id="sat_sun_to"
                                                        placeholder="To"
                                                        value="{{ isset($s_json->to2) ? $s_json->to2 : '' }}">
                                                </div>
                                            </div>
