...
<head>
    ...
    @if (Request::is('/') || $currentRoute == 'front.single_blog_detail')
        <title>{{ $title }}</title>
    @else
        <title>{{ $title }}</title>
    @endif
    ...
    @if (str_ends_with(url()->current(), '/') || url()->current() == url('/'))
    ...
    <link rel="preload" as="image" href="{{ asset('uploads/67ebedfdcb37d.webp') }}" fetchpriority="high" />
    <link rel="preload" as="image" href="{{ asset('uploads/67d16b0342bc2.webp') }}" fetchpriority="high" />
    <link rel="preload" as="image" href="{{ asset('front-assets/src/images/home-page-banner1100.webp') }}"
        fetchpriority="high" />
    <!-- <link rel="preload" as="image" href="{{ asset('uploads/675aa5d5ab11f.webp') }}" fetchpriority="high"/> -->
    <link rel="preload" as="image" href="{{ asset('front-assets/src/images/banner1100.webp') }}"
        fetchpriority="high" />
    <link rel="preload" as="image" href="{{ asset('uploads/67ca884f73e05.webp') }}" fetchpriority="high" />
    <link rel="preload" as="image" href="{{ asset('front-assets/src/images/get-a-free-quote-bg-image.webp') }}"
        fetchpriority="high" />
    <link rel="preload" as="image" href="{{ asset('front-assets/src/images/mobile-open-bar.webp') }}"
        fetchpriority="high" />
    <link rel="preload" as="image" href="{{ asset('front-assets/src/images/desktop-form-bg.webp') }}"
        fetchpriority="high" />
    <link rel="preload" as="image" href="{{ asset('front-assets/src/images/hollow-metal-doors-delaware.webp') }}"
        fetchpriority="high" />

    <!-- 05-08-2025 -->
    <link rel="preload" as="image" href="{{ asset('uploads/small/garage-door-installation-delaware.webp') }}"
        fetchpriority="high" />
    <!-- <link rel="preload" as="image" href="{{ asset('uploads/68480922ea745.webp') }}" fetchpriority="high"/> -->
    <link rel="preload" as="image" href="{{ asset('uploads/small/garage-door-company-delaware.webp') }}"
        fetchpriority="high" />

    <!-- new Preload -->
    <link rel="preload" as="image" href="{{ asset('uploads/garage-door-installation-delaware.webp') }}" />
    <link rel="preload" as="image"
        href="{{ asset('front-assets/src/images/garage-door-installation-and-replacement-delaware.webp') }}" />
    <link rel="preload" as="image"
        href="{{ asset('front-assets/src/images/garage-door-repairs-and-parts-replacement-delaware.webp') }}" />
    <link rel="preload" as="image"
        href="{{ asset('front-assets/src/images/garage-door-openers-delaware.webp') }}" />
    <link rel="preload" as="image"
        href="{{ asset('front-assets/src/images/garage-door-maintenance-and-service-delaware.webp') }}" />
    <link rel="preload" as="image"
        href="{{ asset('front-assets/src/images/garage-door-maintenance-and-service-delaware.webp') }}" />
    <link rel="preload" as="image"
        href="{{ asset('front-assets/front-assets/src/images/loading-dock-equipment-services-delaware.webp') }}" />
    ...
    <link rel="preload" as="style" href="{{ asset('front-assets/src/css/main.css') }}?v=1.3.0" />
    <link rel="preload" as="style" href="{{ url('/api-custom-css') }}" />
    <link rel="preload" as="style" href="{{ asset('front-assets/src/css/font-awesome.min.css') }}">
    <link rel="preload" as="style" href="{{ asset('front-assets/src/css/new-header.css') }}">
    ...
    <link rel="preload" as="script"
        href="{{ asset('front-assets/src/js/vendor/jquery.magnific-popup.min.js') }}" />
...
.footer-sec .footer-content.footer-full-sec {
    ...
    <link href="{{ asset('front-assets/src/css/owl.carousel.min.css') }}" rel="stylesheet">
    <link href="{{ asset('front-assets/src/css/owl.theme.default.min.css') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/main.css') }}?v=1.3.0">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/new-model.css') }}?v=0.0.1">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/hollowmetal.css') }}?v=1.1.2">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/new-header.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('/api-custom-css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/font-awesome.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('front-assets/src/js/parsley.min.js') }}"></script>
    <script src="{{ asset('front-assets/src/js/jquery.mask.js') }}"></script>
