                                    ...
                                    @foreach($ddpcount as $dkey => $dval)
                                        ...
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 commercial-category products-box-section">
                                            <article>
                                                ...
                                                <a href="{{ route('commercial.product_detail', [$lnk, $dval['product_slug']]) }}/">
                                                    <img src="{{ $dval['list_image'] }}" width="auto" height="auto" class="img-fluid" alt="">
                                                </a>
                                                @endif

                                                @if(isset($dval['list_title']))
                                                    <h3><a href="{{ route('commercial.product_detail', [$lnk, $dval['product_slug']]) }}/">{{ $dval['list_title'] }}</a></h3>
                                                @endif
                                                ...
                                                <div class="learn-more-btn-sec">
                                                    <a href="{{ route('commercial.product_detail', [$lnk, $dval['product_slug']]) }}/" class="common-btn">Learn More</a>
                                                </div>
                                            </article>
                                        </div>
                                    @endforeach
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    @if(isset($dlst['list_title']))
                                                        <h3><a href="{{route('commercial.product_detail', [$lnk, $dlst['product_slug']])}}/">{{ $dlst['list_title'] }}</a></h3>
                                                    @endif
                                                    ...
                                                    @endif
                                                    <div class="learn-more-btn-sec">
                                                        <a href="{{route('commercial.product_detail', [$lnk, $dlst['product_slug']])}}/" class="common-btn">Learn More</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                @if(isset($dlst['list_image']) && $dlst['list_image'] != null && $dlst['list_image'] != '')
                                                <a href="{{route('commercial.product_detail', [$lnk, $dlst['product_slug']])}}/" class="image-link">
